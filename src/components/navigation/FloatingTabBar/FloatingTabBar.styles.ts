...
export const styles = StyleSheet.create({
  ...
  item: { height: 48, minWidth: 48, paddingHorizontal: spacing.md, borderRadius: radii.pill, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.xs, overflow: 'hidden' },
  itemActive: { ...StyleSheet.absoluteFill, borderRadius: radii.pill, backgroundColor: colors.ink },
