...
export const styles = StyleSheet.create({
  ...
  currentLabel: { fontFamily: fonts.monoMedium, color: colors.ember, fontSize: 9, letterSpacing: 1.4 },
  liveDot: { width: 5, height: 5, borderRadius: 3, backgroundColor: colors.ember },
