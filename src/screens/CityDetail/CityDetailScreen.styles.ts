...
export const styles = StyleSheet.create({
  ...
  offsetBadge: { fontFamily: fonts.monoMedium, color: colors.graphite, fontSize: 8, letterSpacing: 0.8 },
  ...
  metaLabel: { fontFamily: fonts.monoMedium, fontSize: 9, color: colors.graphite, letterSpacing: 1.4 },
